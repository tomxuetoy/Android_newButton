    ...
    {   
        ...
        {   
            ...
            {   
                ...
                Log.v("TomTag", Integer.toString(off));  // added by Tom Xue, executed in GS3
            }                          
        }   
    };   
    
    //事件监听. To make the focus on Button01, by Tom Xue
    private View.OnKeyListener mNewButtonKeyListener = new View.OnKeyListener() 
    {   
        public boolean onKey(View v, int keyCode, KeyEvent event) 
        {   
            if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN &&   // Directional Pad Down key, GS3 doesn't have it
                    event.getAction() == KeyEvent.ACTION_DOWN &&   
                    v == mLayout.getChildAt(mLayout.getChildCount() - 1)) 
            {   
                findViewById(R.id.Button01).requestFocus();   
                Log.v("TomTag", "mNewButtonKeyListener");  // added by Tom Xue, not executed in GS3
                return true;   
            }   
            return false;   
        }   
        ...
        {   
            ...
            {   
                ...
                case KeyEvent.KEYCODE_DPAD_DOWN:   
                    ...
                    {   
                        viewToFoucus = mLayout.getChildAt(iCount + 1);   
                        Log.v("TomTag2", Float.toString(mLayout.getWeightSum()));  // added by Tom Xue, not executed in GS3
                    }   
                    break;   
                default:   
                    break;   
